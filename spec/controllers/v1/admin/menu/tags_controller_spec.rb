...
RSpec.describe V1::Admin::Menu::TagsController, type: :controller do
  ...
  context '#destroy' do
    ...
    it { expect(described_class).to route(:DELETE, '/v1/admin/menu/tags/22').to(action: :destroy, format: :json, id: 22) }
  ...
  context '#copy' do
    ...
    it { should route(:post, '/v1/admin/menu/tags/22/copy').to(format: :json, action: :copy, controller: 'v1/admin/menu/tags', id: 22) }
    let!(:tag) { create(:menu_tag) }
