...
RSpec.describe "Routing /v1/admin/menu/allergens" do
  ...
  it { expect(patch: "/v1/admin/menu/allergens/77").to route_to("v1/admin/menu/allergens#update", format: :json, id: "77") }
  it { expect(delete: "/v1/admin/menu/allergens/77").to route_to("v1/admin/menu/allergens#destroy", format: :json, id: "77") }
  it { expect(post: "/v1/admin/menu/allergens/77/copy").to route_to("v1/admin/menu/allergens#copy", format: :json, id: "77") }
  it { expect(post: "/v1/admin/menu/allergens/52/copy").to route_to("v1/admin/menu/allergens#copy", format: :json, id: "52") }
end
