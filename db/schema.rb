...
ActiveRecord::Schema[7.0].define(version: 27) do
  ...
  create_table 'image_to_records', force: :cascade do |t|
    ...
    t.index %w[position record_type record_id], name: 'index_image_to_records_on_position_and_record_and_image',
                                                unique: true
    t.index %w[record_type record_id image_id], name: 'index_image_to_records_on_record_and_image', unique: true
    t.index %w[record_type record_id], name: 'index_image_to_records_on_record'
  end
  ...
  create_table 'images', force: :cascade do |t|
    ...
    t.index %w[tag original_id], name: 'index_images_on_tag_and_original_id', unique: true,
  ...
  create_table 'log_delivered_emails', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[record_type record_id], name: 'index_log_delivered_emails_on_record'
  end
  ...
  create_table 'log_image_pixels', force: :cascade do |t|
    ...
    t.index %w[record_type record_id], name: 'index_log_image_pixels_on_record'
  ...
  create_table 'log_model_changes', force: :cascade do |t|
    ...
    t.jsonb 'record_changes', null: false,
                              comment: 'Changes made to the record. Format: { field_name: [old_value, new_value] }'
    t.string 'changed_fields', comment: 'List of fields that were changed. Format: [field_name1, field_name2, ...]',
                               array: true
    ...
    t.index %w[record_type record_id], name: 'index_log_model_changes_on_record'
  ...
  create_table 'menu_allergens_in_dishes', force: :cascade do |t|
    ...
    t.index %w[menu_dish_id index], name: 'index_menu_allergens_in_dishes_on_menu_dish_id_and_index', unique: true
    t.index %w[menu_dish_id menu_allergen_id], name: 'index_menu_allergens_in_dishes_on_dish_and_allergen',
                                               unique: true
  ...
  create_table 'menu_categories', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[index parent_id], name: 'index_menu_categories_on_index_and_parent_id', unique: true
    ...
    t.index ['secret_desc'], name: 'index_menu_categories_on_secret_desc', unique: true,
                             where: '(secret_desc IS NOT NULL)'
  end
  ...
  create_table 'menu_dishes_in_categories', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[index menu_category_id], name: 'index_menu_dishes_in_categories_on_index_and_menu_category_id',
                                        unique: true
    ...
    t.index %w[menu_dish_id menu_category_id], name: 'index_menu_dish_id_menu_category_id', unique: true
  ...
  create_table 'menu_ingredients_in_dishes', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[menu_dish_id index], name: 'index_menu_ingredients_in_dishes_on_menu_dish_id_and_index', unique: true
    t.index %w[menu_dish_id menu_ingredient_id], name: 'index_menu_ingredients_in_dishes_on_dish_and_ingredient',
                                                 unique: true
  ...
  create_table 'menu_tags_in_dishes', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[menu_dish_id index], name: 'index_menu_tags_in_dishes_on_menu_dish_id_and_index', unique: true
    t.index %w[menu_dish_id menu_tag_id], name: 'index_menu_tags_in_dishes_on_dish_and_tag', unique: true
  ...
  create_table 'reservation_turns', force: :cascade do |t|
    ...
    t.integer 'step', default: 30, null: false,
  ...
  create_table 'tag_in_reservations', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[reservation_id reservation_tag_id], name: 'reservation_id_on_tags', unique: true
