...
module Menu
  class Visibility < ApplicationRecord
    ...
    def public_from_should_be_before_public_to
      ...
      errors.add(:public_from, I18n.t('activerecord.errors.messages.public_from_should_be_before_public_to', public_from:, public_to:))
      errors.add(:public_to, I18n.t('activerecord.errors.messages.public_to_should_be_after_public_from', public_from:, public_to:))
    end
    ...
    def private_from_should_be_before_private_to
      ...
      errors.add(:private_from, I18n.t('activerecord.errors.messages.private_from_should_be_before_private_to', private_from:, private_to:))
      errors.add(:private_to, I18n.t('activerecord.errors.messages.private_to_should_be_after_private_from', private_from:, private_to:))
    end
  end
end
